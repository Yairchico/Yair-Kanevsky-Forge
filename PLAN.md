...
- [~] שלב 3 – חוויית מתאמן (מסך שבועי, סימון כל תרגיל בנפרד + הגשת אימון שלם, המאמן רואה סטטוס לפי תרגיל דרך "השבוע שלו" ✓; **חסר עדיין**: מסך היסטוריה לחודש אחורה + טופס ביצוע מפורט (משקל/חזרות בפועל) מעבר לסימון בוצע/לא)
- [ ] שלב 4 – ליטוש ו-QA
